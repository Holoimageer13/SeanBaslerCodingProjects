...
const int YARMAX = 20;
const int YARMIN = 5;
const int YARTRASH =100;
//not cast as an int because then it makes the array definition in school angry
const int MAXYARTRA = (MAXX*MAXX*PERC_TRASH);
